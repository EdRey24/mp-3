        ...
        <Main>
            ...
            <ContentContainer>
                ...
                <p>I have been selected as a Boston University QuestBridge Scholar. This prestigious honor reflects my
                    ...
                    universities, and being chosen as a Scholar at Boston University is a significant milestone in my
                    educational journey. This recognition not only provides invaluable financial support but also
            ...
            <ContentContainer>
                ...
                <p>I am honored to be a recipient of the Valley Alliance of Mentors for Opportunities and Scholarships
                    ...
                    essential financial assistance and support to students from low socioeconomic backgrounds, many of
                    whom are first-generation college students. As a VAMOS scholar, I am part of a program that has
                    awarded over $25 million in scholarships to more than 1,250 students. This four-year renewable
                    scholarship not only supports my academic endeavors but also provides access to invaluable resources
            ...
            <ContentContainer>
                ...
                <p>I am honored to have been selected as a Hispanic Scholarship Fund Scholar. This prestigious
                    ...
                    students of Hispanic heritage by providing them with the resources needed to pursue higher education
                    and achieve their professional goals. Being a part of this esteemed network of scholars is a
            ...
            <ContentContainer>
                ...
                <p>I participated in the Congressional App Challenge (CAC), an annual district-specific competition
                    ...
                    students like me with a unique opportunity to showcase their original apps and creative solutions.
                    Winning teams are publicly recognized by U.S. Representatives, and their apps may be displayed in
                    the U.S. Capitol Building for a year. As a winner, I joined a select group of students challenged to
                    develop and submit an app that demonstrates technical skill and creativity. My app Cash Alert
                    offered a free solution for organizing school/community fundraisers through Google App Script, HTML,
                    and Google Sheets, providing weekly email reminders and payment management to student organizations,
                    addressing the limitations of costly and restrictive alternatives. This experience not only allowed
                    me to hone my programming skills but also to engage with a broader community passionate about
